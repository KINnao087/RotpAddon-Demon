...
public class DemonStandHeavyAttack extends StandEntityHeavyAttack {
    public static float probability = 1.0f;

    public DemonStandHeavyAttack(StandEntityHeavyAttack.Builder builder) {
        super(builder);
    }
