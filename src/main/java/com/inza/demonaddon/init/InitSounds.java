...
public class InitSounds {
    ...
    public static final Supplier<SoundEvent> DEMON_STAND_SUMMON = SOUNDS.register("demon_stand_summon",
            () -> new SoundEvent(new ResourceLocation(AddonMain.MOD_ID, "demon_stand_summon")));
