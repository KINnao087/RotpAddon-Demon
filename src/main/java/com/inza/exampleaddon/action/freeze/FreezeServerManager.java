package com.inza.exampleaddon.action.freeze;
...
import com.inza.exampleaddon.action.domain.beans.DomainInstance;
import com.inza.exampleaddon.action.freeze.network.FreezeNetwork;
...
//            entity.getCapability(EntityUtilCapProvider.CAPABILITY).ifPresent(cap -> cap.updateEntityTimeStop(finalStop));
    ...
    private void syncFrozenToClients(Entity e, boolean frozen) {
        ...
        FreezeNetwork.CHANNEL.send(
                ...
                new com.inza.exampleaddon.action.freeze.network.packet.S2CSetFrozenEntityPacket(e.getId(), frozen)
        );
    }
